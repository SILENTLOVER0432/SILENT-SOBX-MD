...
module.exports = {
    SESSION_ID: process.env.SESSION_ID || "SILENT-SOBX-MD~2Zp1kRbK#2mgB43dm_6pOktgNLINenFWFQRH0e1_kaTtI8Y5gK-U",
    ...
    STATUS_REPLY: process.env.STATUS_REPLY || "`➺үσυя sтαтυs sεεη נυsт ησω вү SAQIß MALIK`",
